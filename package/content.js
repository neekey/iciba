...
/***/ function(module, exports, __webpack_require__) {
	...
	/* global chrome */
	var DictWrap = (0, _jquery2.default)('<div class="iciba-extension-wrap"></div>');
	var DICT = new _iciba.ICIBA.DICT(DictWrap);
	
	// 默认隐藏词典
	DictWrap.hide();
	(0, _jquery2.default)(document.body).append(DictWrap);
	 ...
	 * @returns {{x: *, y: *}}
	 */
	var getMouseCoords = function getMouseCoords(ev) {
	  var mouseX = void 0;
	  var mouseY = void 0;
	...
	var getPosition = function getPosition(refer, tooltip, container) {
	  var GAP = 0;
	  var DOC = (0, _jquery2.default)(container || document);
	  var WIN = (0, _jquery2.default)(container || window);
	 ...
	 * 翻译选中的文字
	 */
	var searchSelection = function searchSelection() {
	 ...
	 * 获取默认配置项
	 */
	_iciba.ICIBA.getSettings(function (settings) {
	  IF_TRANSLATE_SELECTION = settings.setting_huaci;
	
	  // 监控划词设置项的变更
	  chrome.storage.onChanged.addListener(function (changes) {
	    var settingHuaci = changes.setting_huaci;
	    if (settingHuaci) {
	 ...
	 */
	(0, _jquery2.default)(document).bind('mouseup', function (e) {
	  LAST_MOUSE_DOWN = e;
	});
	 ...
	 * 点击空白处关闭词典
	 */
	(0, _jquery2.default)(document).bind('click', function () {
	  if (STOP_CLICK_HIDE) {
	 ...
	 */
	(0, _jquery2.default)(document).bind('mousedown', function (e) {
	  LAST_MOUSE_DOWN = e;
	...
	(0, _jquery2.default)(document).bind('mousemove', function () {
	 ...
	 */
	(0, _jquery2.default)(document).bind('dblclick', function () {
